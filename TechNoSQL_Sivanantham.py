...
pprint.pprint(bestcode) """ Il semble avantageux d'habiter dans le zip code 10038 """

""" Regardons si il y a des hopitaux dans 1 de ces code postaux """
health.count({'location_1_zip':repr(bestcode['_id'])}) """ Il y en a 1 ! ce lieu semble parfait pour y vivre """
health.count({'location_1_zip':'10004'}) """ Il y en a pas ..."""
...
pprint.pprint(list(resbusiness)) """ Interessant il y a une grande diversité de commerces notamment une dizaine de magasin d'électronics et de vente d'occasion"""
